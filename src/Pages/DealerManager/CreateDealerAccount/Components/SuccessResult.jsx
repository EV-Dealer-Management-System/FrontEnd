    ...
    return (
        <Card className="shadow-md rounded-lg max-w-4xl mx-auto border-0">
                ...
                subTitle={
                    <Space direction="vertical" size="small" className="mt-4">
                        <Text className="text-base text-gray-600">
                            Tài khoản Dealer Staff đã được tạo và thông tin đăng nhập đã được gửi qua email.
                        </Text>
                        <Text type="secondary">
                ...
                extra={
                    <Space size="middle" className="mt-8">
                        <Button
                            ...
                            className="bg-green-600 hover:bg-green-700 border-0 h-11 px-8 rounded-lg font-medium"
                        >
                            Tạo tài khoản khác
                        </Button>
                        <Button
                            size="large"
                            onClick={() => window.location.href = '/dealer-manager'}
            ...
            >
                ...
                {createdAccount && (
                    <Card
                        className="mt-8 bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-lg shadow-sm"
