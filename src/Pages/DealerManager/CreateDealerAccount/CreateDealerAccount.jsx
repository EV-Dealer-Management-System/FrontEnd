...
function CreateDealerAccount() {
    ...
    const handleSubmit = async (values) => {
        ...
        try {
            const response = await CreateDealerStaff.createStaffAccount(values);

            if (response?.isSuccess) {
                message.success('Tạo tài khoản Dealer Staff thành công!');
            ...
            console.error('Error creating dealer staff account:', error);
                ...
                header={{
                    title: (
                        <Space size="middle">
                            ...
                            <div>
                                <div className="text-2xl font-bold text-gray-800">Tạo tài khoản Dealer Staff</div>
                            </div>
                        </Space>
                    ),
                }}
                    ...
                    description={
                        <div>
                            <Paragraph className="mb-2 text-sm">
                                <Text strong>Dealer Staff</Text> là nhân viên của đại lý với các quyền hạn:
                            </Paragraph>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                                <div className="flex items-center gap-2">
                                    <CheckCircleOutlined className="text-green-500" />
                                    <span>Tạo đơn đặt xe từ nhà sản xuất</span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <CheckCircleOutlined className="text-green-500" />
                                ...
                                <div className="flex items-center gap-2">
                                    <CheckCircleOutlined className="text-green-500" />
                                    <span>Tạo hợp đồng bán xe</span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <CheckCircleOutlined className="text-green-500" />
                                    <span>Xem báo cáo doanh số cá nhân</span>
                                </div>
                            </div>
                        </div>
                    }
                ...
                <ProCard className="shadow-sm">
                    ...
                    >
                        ...
                        <ProFormText
                            ...
                            placeholder="Nhập email (VD: nguyenvana@dealer.com)"
                            rules={[
...
export default CreateDealerAccount;
